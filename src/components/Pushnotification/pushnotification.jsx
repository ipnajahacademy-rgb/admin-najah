...
export default function NotificationsOperations() {
    ...
    // FETCH STUDENTS
    //
    // Your getAllUsers controller returns:
    // {
    //   success: true,
    //   count: ...,
    //   users: [...]
    ...
    const fetchStudents = async () => {
        ...
        try {
             ...
             * IMPORTANT:
             *
             * Your backend controller has getAllUsers().
             * If your user route is different, only change
             * this URL.
             *
             * Example expected:
             * GET /api/users
    ...
    const getSelectedUserData = () => {
        ...
        if (receiverType === "teacher") {
            return teachers.find(
                (teacher) =>
                    teacher._id === selectedUser
            );
        }

        return students.find(
            (student) =>
                student._id === selectedUser
        );
    };
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 max-w-3xl">
                ...
                <div className="text-sm text-blue-700 space-y-1">
                    ...
                    <p>
                        3. The user's MongoDB <b>_id</b> is
                        automatically used as <b>userId</b>.
                    </p>
                    ...
                    <p>
                        ...
                        <b> fcmTokens</b> and sends through
                        Firebase.
                    </p>
